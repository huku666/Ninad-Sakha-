...
public class TodoAdapter extends RecyclerView.Adapter<TodoAdapter.TodoViewHolder> {
    ...
    */
    private int getPriorityColor(int priority) {
        ...
        switch (priority) {
            case 1:
                priorityColor = ContextCompat.getColor(mContext, R.color.moonstone);
                break;
            case 2:
                priorityColor = ContextCompat.getColor(mContext, R.color.flowergirl);
                break;
            case 3:
                priorityColor = ContextCompat.getColor(mContext, R.color.acidgreen);
                break;
            default:
                break;
        }
